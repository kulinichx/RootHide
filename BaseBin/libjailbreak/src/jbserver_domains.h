...
enum {
    ...
    // Action 2 is intentionally reserved for legacy protocol compatibility.
    JBS_ROOTHIDE_BLACKLIST_CHECK = 3,
    JBS_ROOTHIDE_JAILBREAKD_LOOKUP = 4,
    JBS_ROOTHIDE_JAILBREAKD_CHECKIN = 5,
    JBS_ROOTHIDE_TRUST_LIBRARY_RECURSE = 6,
    JBS_ROOTHIDE_TRUST_EXECUTABLE_RECURSE = 7,
    JBS_ROOTHIDE_DYLD_PATCH_ENABLED_GET = 8,
    JBS_ROOTHIDE_DYLD_PATCH_ENABLED_SET = 9,
};
