...
"    float edgeWeight = pow(max(rimWeight, 0.0), 1.18);\n"
...
"    float tightSpec = pow(ndh, 54.0);\n"
"    float broadSpec = pow(ndh, 12.0);\n"
"    float edgeCore = exp(-pow(insideDepth / 0.72, 2.0));\n"
"    float edgeBody = exp(-pow(insideDepth / 3.10, 2.0));\n"
"    float specular = u.specularStrength * edgeWeight *\n"
"                     (0.18 * fresnel + 0.55 * tightSpec + 0.12 * broadSpec) *\n"
"                     (0.35 + 0.65 * edgeBody);\n"
...
"                          (0.06 + 0.58 * opposing);\n"
"    float farGlint = u.specularStrength * 0.08 * edgeCore * opposing;\n"
